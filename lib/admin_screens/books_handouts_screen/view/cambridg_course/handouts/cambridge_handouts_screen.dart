...
class CambridgeHandoutsScreen extends StatefulWidget {
  final String title;
  const CambridgeHandoutsScreen({super.key,required this.title});

  @override
  State<CambridgeHandoutsScreen> createState() => _OxfordHandoutsScreenState();
}

class _OxfordHandoutsScreenState extends State<CambridgeHandoutsScreen> {

  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getCambridgeCourses(section: 'handouts');
  }
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
               customPushNavigator(context, UploadCambridgeHandouts(section: 'handouts',type: '',));
              },
              child: Icon(
