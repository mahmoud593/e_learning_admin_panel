...
class MarkedCambridgeAssignmentScreen extends StatefulWidget {
  ...
  @override
  State<MarkedCambridgeAssignmentScreen> createState() => _IeltsHandoutsScreenState();
}

class _IeltsHandoutsScreenState extends State<MarkedCambridgeAssignmentScreen> {
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
                customPushNavigator(context, UploadCambridgeHomeWork(section: 'markedAssignments',index: 1,));
              },
              child: Icon(
