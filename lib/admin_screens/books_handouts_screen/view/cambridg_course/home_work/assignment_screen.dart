...
import 'package:e_learning_dathboard/admin_screens/books_handouts_screen/view/cambridg_course/home_work/edit_campbridget_home_work.dart';
import 'package:e_learning_dathboard/admin_screens/books_handouts_screen/view/cambridg_course/home_work/upload_oxford_home_work.dart';
...
class AssignmentCambridgeScreen extends StatefulWidget {
  const AssignmentCambridgeScreen({super.key});

  @override
  State<AssignmentCambridgeScreen> createState() => _IeltsHandoutsScreenState();
}

class _IeltsHandoutsScreenState extends State<AssignmentCambridgeScreen> {

  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getCambridgeSpeakingCourses(
        section: 'assignments',
        filed: 'homeWork'
    );
  }
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
                customPushNavigator(context, UploadCambridgeHomeWork(section: 'assignments',index: 0,));
              },
              child: Icon(
...
''';
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                        onPressed: (){
                                          customPushNavigator(context, EditHomeWorkCambridget(
                                            uId: cubit.cambridgeCoursesList[index].uId,
                                            index: 0,
                                            title: cubit.cambridgeCoursesList[index].title,
