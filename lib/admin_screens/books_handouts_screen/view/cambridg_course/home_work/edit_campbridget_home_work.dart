...
class EditHomeWorkCambridget extends StatefulWidget {
  EditHomeWorkCambridget({super.key,required this.section,required this.index,required this.uId,required this.title,required this.url});
  ...
  @override
  State<EditHomeWorkCambridget> createState() => _EditOxfordSpeackingState();
}

class _EditOxfordSpeackingState extends State<EditHomeWorkCambridget> {
