...
class UploadCambridgeSpeacking extends StatelessWidget {
  UploadCambridgeSpeacking({super.key,required this.section,required this.index});
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          cubit.uploadCambridgeSpeakingCourses(
