...
class UploadOxfordSpeacking extends StatelessWidget {
  UploadOxfordSpeacking({super.key,required this.section,required this.index});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title:  index==0? Text('Upload Audio'):  Text('Upload Pdf'),
        ),
        body: BlocConsumer<AppCubit,AppStates>(
          listener: (context, state) {
            if(state is UploadOxfordCoursesSuccessState){
          ...
          builder: (context, state) {
            ...
            return  ModalProgressHUD(
                inAsyncCall: state is UploadOxfordCoursesLoadingState,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          cubit.uploadOxfordSpeakingCourses(
                              title: controller.text,
                              filed: 'speaking',
                              section: index==0?'audio':'pdf'
                          );
                        },
                        child: Container(
