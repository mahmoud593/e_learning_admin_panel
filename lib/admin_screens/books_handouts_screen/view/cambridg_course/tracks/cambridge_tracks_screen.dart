...
class CambridgeTracksScreen extends StatefulWidget {
  ...
  @override
  State<CambridgeTracksScreen> createState() => _TracksScreenState();
}

class _TracksScreenState extends State<CambridgeTracksScreen> {
  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getCambridgeCourses(section: 'tracks');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
            onPressed: () {
              customPushNavigator(context, CambridgeUploadTracks(section: 'tracks'));
            },
            label: Row(
              children: [
                Icon(
