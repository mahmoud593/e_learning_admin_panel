...
class EditCambridgetTrack extends StatefulWidget {
  const EditCambridgetTrack({super.key,required this.section, required this.uId,required this.title,required this.url});
  ...
  @override
  State<EditCambridgetTrack> createState() => _EditOxfordHandoutsState();
}

class _EditOxfordHandoutsState extends State<EditCambridgetTrack> {
    ...
    return Scaffold(
        ...
        body: BlocConsumer<AppCubit,AppStates>(
          listener: (context, state) {
            if(state is UpdateCambridgeCoursesSuccessState){
          ...
          builder: (context, state) {
            ...
            return  ModalProgressHUD(
                inAsyncCall: state is UpdateCambridgeCoursesLoadingState,
