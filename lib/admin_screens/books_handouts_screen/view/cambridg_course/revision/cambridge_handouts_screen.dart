...
class CambridgeRevisionScreen extends StatefulWidget {
  final String title;
  const CambridgeRevisionScreen({super.key,required this.title});

  @override
  State<CambridgeRevisionScreen> createState() => _OxfordHandoutsScreenState();
}

class _OxfordHandoutsScreenState extends State<CambridgeRevisionScreen> {

  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getCambridgeCourses(section: 'revision');
  }
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
               customPushNavigator(context, UploadCambridgeHandouts(section: 'revision', type: 'exams',));
              },
              child: Icon(
