...
class UploadIeltsSpeacking extends StatelessWidget {
  UploadIeltsSpeacking({super.key,required this.section,required this.index});
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          cubit.uploadIeltsSpeakingCourses(
