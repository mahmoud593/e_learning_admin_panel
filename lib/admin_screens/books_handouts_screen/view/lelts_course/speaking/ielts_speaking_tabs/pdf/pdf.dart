...
class IeltsPdfSpeakerScreen extends StatefulWidget {
  ...
  @override
  State<IeltsPdfSpeakerScreen> createState() => _IeltsHandoutsScreenState();
}

class _IeltsHandoutsScreenState extends State<IeltsPdfSpeakerScreen> {

  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getIeltsSpeakingCourses(section: 'pdf');
  }
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
                customPushNavigator(context, UploadIeltsSpeacking(section: 'pdf',index: 1,));
              },
              child: Icon(
