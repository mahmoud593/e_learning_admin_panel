...
class EditIeltsSpeacking extends StatefulWidget {
  EditIeltsSpeacking({super.key,required this.section,required this.index,required this.uId,required this.title,required this.url});
  ...
  @override
  State<EditIeltsSpeacking> createState() => _EditOxfordSpeackingState();
}

class _EditOxfordSpeackingState extends State<EditIeltsSpeacking> {
    ...
    return Scaffold(
        ...
        body: BlocConsumer<AppCubit,AppStates>(
          listener: (context, state) {
            if(state is UpdateIeltsSpeakingSuccessState){
          ...
          builder: (context, state) {
            ...
            return  ModalProgressHUD(
                inAsyncCall: state is UpdateIeltsSpeakingLoadingState,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          cubit.updateIeltsSpeakingCourses(
                      ...
                      DefaultButton(
                          ...
                          text: 'Save',
                          onPressed: (){
                            cubit.updateIeltsSpeakingCoursesWithoutUrl(
                                title: controller.text,
                                url: widget.url,
                                filed: 'speaking',
                                uId: widget.uId,
