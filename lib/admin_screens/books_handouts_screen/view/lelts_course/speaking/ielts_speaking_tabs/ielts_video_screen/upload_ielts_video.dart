...
class VideoIeltsUploadScreen extends StatefulWidget {
  @override
  _VideoUploadScreenState createState() => _VideoUploadScreenState();
}

class _VideoUploadScreenState extends State<VideoIeltsUploadScreen>
      ...
      builder: (context, state) {
        return Scaffold(
          body: ModalProgressHUD(
            ...
            inAsyncCall: context.read<AppCubit>().isUploadingIeltsVideo,
            child: Container(
  ...
  Widget _buildUploadButton() {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap:(){
            context.read<AppCubit>().uploadIeltsVideoToFirebase(title: _titleController.text, section: 'video', filed: 'speaking',result: result!);
          },
          borderRadius: BorderRadius.circular(16),
          child: Container(
