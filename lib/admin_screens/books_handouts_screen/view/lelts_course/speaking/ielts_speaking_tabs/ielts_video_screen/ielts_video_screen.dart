import 'package:e_learning_dathboard/admin_screens/books_handouts_screen/view/lelts_course/speaking/ielts_speaking_tabs/ielts_video_screen/comments_ilets_screen.dart';
...
class IeltsVideoScreen extends StatefulWidget {
  const IeltsVideoScreen({super.key});

  @override
  State<IeltsVideoScreen> createState() => _TracksScreenState();
}

class _TracksScreenState extends State<IeltsVideoScreen> {
  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getIeltsVideoSpeakingCourses();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: FloatingActionButton.extended(
            onPressed: () {
              customPushNavigator(context, VideoIeltsUploadScreen());
            },
            label: Row(
              children: [
                Icon(
                ...
                builder: (context, state) {
                  ...
                  Container(
                    child: ListView.separated(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    cubit.ieltsVideoCoursesList[index].title,
                                                    style: TextStyle(
                                            ...
                                            Container(
                                              ...
                                              child: IconButton(
                                                onPressed: () async {
                                                  await Share.share(
                                                    'شاهد هذا الفيديو : ${cubit.ieltsVideoCoursesList[index].title} \n ${cubit.ieltsVideoCoursesList[index].url}',
                                                  );
                                                },
                                                icon: Icon(
                                                  Icons.share_rounded,
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              customPushNavigator(
                                                context,
                                                VideoPlayerScreen(
                                                  videoUrl: cubit.ieltsVideoCoursesList[index].url,
                                                  videoTitle: cubit.ieltsVideoCoursesList[index].title,
                                                ),
                                              );
                                            },
                                            child: Container(
                                      ...
                                      children: [
                                                  ...
                                                  actions: [
                                                    ...
                                                    TextButton(
                                                      onPressed: () {
                                                        ...
                                                        cubit.deleteIeltsVideoSpeakingCourses(
                                                          uId: cubit.ieltsVideoCoursesList[index].uId,
                                                        );
                                                      },
                                        ...
                                        Container(
                                          ...
                                          child: IconButton(
                                            onPressed: () {
                                              // Show confirmation dialog
                                              cubit.getieltsVideoComments(uId:  cubit.ieltsVideoCoursesList[index].uId, ).then((value) {
                                                customPushNavigator(context, CommentsIletsScreen(videoTitle: cubit.ieltsVideoCoursesList[index].title,videoUid:cubit.ieltsVideoCoursesList[index].uId ,));
                                              });
                                            },
                                            icon: Icon(
                        ...
                        itemCount: cubit.ieltsVideoCoursesList.length),
                  );
                })));
  }
}
