...
class OxfordTabsMockScreen extends StatelessWidget {
  const OxfordTabsMockScreen({super.key});
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        /// appbar
          ...
          body:  TabBarView(
            children: [
              OxfordMockExamsScreen(title: 'Mock Exams',),
              OxfordMarkedAssigmnetMockScreen(title: 'Mock Exams',),
            ],
          )),
    );
  }
