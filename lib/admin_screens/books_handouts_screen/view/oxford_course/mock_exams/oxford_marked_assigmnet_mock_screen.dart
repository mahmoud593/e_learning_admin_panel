...
class OxfordMarkedAssigmnetMockScreen extends StatefulWidget {
  final String title;
  const OxfordMarkedAssigmnetMockScreen({super.key,required this.title});

  @override
  State<OxfordMarkedAssigmnetMockScreen> createState() => _OxfordHandoutsScreenState();
}

class _OxfordHandoutsScreenState extends State<OxfordMarkedAssigmnetMockScreen> {

  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getOxfordCourses(section: 'mockExams',type: 'markedAssignments');
  }
      ...
      builder: (context,state){
        ...
        return Scaffold(
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
                customPushNavigator(context, UploadOxfordHandouts(section: 'mockExams',type: 'markedAssignments',));
              },
              child: Icon(
