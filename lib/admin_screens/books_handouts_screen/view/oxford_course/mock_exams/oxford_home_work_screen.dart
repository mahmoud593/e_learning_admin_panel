...
class OxfordMockExamsScreen extends StatefulWidget {
  final String title;
  const OxfordMockExamsScreen({super.key,required this.title});

  @override
  State<OxfordMockExamsScreen> createState() => _OxfordHandoutsScreenState();
}

class _OxfordHandoutsScreenState extends State<OxfordMockExamsScreen> {
      ...
      builder: (context,state){
        ...
        return Scaffold(
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
               customPushNavigator(context, UploadOxfordHandouts(section: 'mockExams',type: 'exams',));
              },
              child: Icon(
