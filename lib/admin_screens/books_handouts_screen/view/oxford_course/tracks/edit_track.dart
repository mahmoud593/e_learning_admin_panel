...
class EditOxfordTrack extends StatefulWidget {
  EditOxfordTrack({super.key,required this.section, required this.uId,required this.title,required this.url});
  ...
  @override
  State<EditOxfordTrack> createState() => _EditOxfordHandoutsState();
}

class _EditOxfordHandoutsState extends State<EditOxfordTrack> {
    ...
    return Scaffold(
        ...
        body: BlocConsumer<AppCubit,AppStates>(
          listener: (context, state) {
            if(state is UpdateOxfordCoursesSuccessState){
          ...
          builder: (context, state) {
            ...
            return  ModalProgressHUD(
                inAsyncCall: state is UpdateOxfordCoursesLoadingState,
