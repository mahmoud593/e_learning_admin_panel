...
class OxfordPdfSpeakerScreen extends StatefulWidget {
  const OxfordPdfSpeakerScreen({super.key});

  @override
  State<OxfordPdfSpeakerScreen> createState() => _IeltsHandoutsScreenState();
}

class _IeltsHandoutsScreenState extends State<OxfordPdfSpeakerScreen> {

  @override
  void initState() {
    super.initState();
    AppCubit.get(context).getOxfordSpeakingCourses(section: 'pdf',filed: 'speaking');
  }
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
                customPushNavigator(context, UploadOxfordSpeacking(section: 'pdf',index: 1,));
              },
              child: Icon(
                              ...
                              children: [
                                Row(
                                    children: [
                                      ...
                                      IconButton(
                                          onPressed:()async{
                                            await Share.share(' اسمع هذا الملف : ${cubit.oxfordCoursesList[index].title} \n ${cubit.oxfordCoursesList[index].url}');
                                          } ,
