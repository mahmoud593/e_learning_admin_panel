...
class UploadOxfordHomeWork extends StatelessWidget {
  UploadOxfordHomeWork({super.key,required this.section,required this.index});
                      ...
                      GestureDetector(
                        onTap: (){
                          cubit.uploadOxfordSpeakingCourses(
                              ...
                              filed: 'homeWork',
                              section: index==0?'assignments':'markedAssignments'
                          );
                        },
                        child: Container(
