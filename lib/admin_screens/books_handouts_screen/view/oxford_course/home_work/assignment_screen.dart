...
class AssignmentOxfordScreen extends StatefulWidget {
  const AssignmentOxfordScreen({super.key});

  @override
  State<AssignmentOxfordScreen> createState() => _IeltsHandoutsScreenState();
}

class _IeltsHandoutsScreenState extends State<AssignmentOxfordScreen> {
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: (){
                customPushNavigator(context, UploadOxfordHomeWork(section: 'assignments',index: 0,));
              },
              child: Icon(
