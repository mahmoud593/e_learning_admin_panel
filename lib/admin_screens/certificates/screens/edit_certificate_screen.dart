...
class _EditCertificateScreenState extends State<EditCertificateScreen> {
  ...
  void initState() {
    ...
    super.initState();
    certificateNameController.text = widget.title;
    certificateLinkController.text = widget.link;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Edit Certificate',style: TextStyle(
              color: Colors.black,
        ...
        body: BlocConsumer<AppCubit,AppStates>(
            ...
            builder: (context, state) {
              ...
              return ModalProgressHUD(
                inAsyncCall: state is UpdateCertificateLoadingState,
